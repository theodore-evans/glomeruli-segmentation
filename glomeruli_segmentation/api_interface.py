...
class ApiInterface:
    ...
    async def get_input(self, key: str, input_type: Type) -> Union[Rectangle, Wsi]:
    ...
    async def post_output(self, key: str, data: dict) -> ClientResponse:
        """
    ...
    async def get_wsi_tile(self, slide: Wsi, rect: Rectangle) -> Tile:
        """
    ...
    async def put_finalize(self) -> ClientResponse:
        """
